...
"""Compatibility spec for older local launcher build commands.

The canonical release spec is `packaging/NeuroPOMDP.spec`; this file keeps
`python -m PyInstaller launcher.spec` building the same launcher-based application.
"""
